    ...
    super({
      ...
      vertexShader: `
        ...
        void main() {
          ...
          float response = 0.018 + uActivity * 0.038 + uEvolution * 0.028 + uMutation * 0.042 + uGrowth * 0.032 + uFormChange * 0.065 - uInstability * 0.012;
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          vec3 spectral = hue(fract(uColorShift * 0.92 + uTime * 0.018 + cells * 0.16));
          ...
          color = mix(color, spectral, clamp(0.22 + uColorShift * 0.58 + uEvolution * 0.18, 0.0, 0.82));
          color += vec3(0.0, 0.16, 0.24) * ocean;
          color += uGlowColor * edge * (0.16 + activity * 0.24);
          color += spectral * pow(cells, 6.0) * (0.08 + uMutation * 0.2);
          color *= 0.72 + sin(uTime * 4.0) * (0.045 + activity * 0.05);
