    ...
    super({
      ...
      vertexShader: `
        ...
        void main() {
          ...
          float response = 0.008 + uActivity * 0.018 + uEvolution * 0.012 + uMutation * 0.018 + uGrowth * 0.01 + uFormChange * 0.024 - uInstability * 0.006;
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          vec3 color = mix(cyan, violet, clamp(cells * 0.55 + uMutation * 0.35 + uFormChange * 0.18, 0.0, 1.0));
          color = mix(color, gold, clamp(uColorShift * 0.72, 0.0, 1.0));
